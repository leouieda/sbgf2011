...
seeds = []
seeds.append(gplant.get_seed((1501, 1501, 1501), 2000, mesh))
...
p = vis.plot_prism_mesh(fatiando.mesh.vfilter(mesh,900,2001), style='surface', opacity=0.4)
p.actor.mapper.scalar_visibility = False
p.actor.property.edge_visibility = False
p.actor.property.color = (0,0,0)

#p = vis.plot_prism_mesh(mesh, style='wireframe')
#p.actor.mapper.scalar_visibility = False
#p.actor.property.color = (0,0,0)
